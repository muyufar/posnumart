<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="#" class="nav-link" id="numart-dark-mode-toggle" title="Mode gelap" aria-pressed="false">
          <i class="fas fa-moon"></i>
          <span class="numart-dark-mode-label d-none d-md-inline ml-1">Dark</span>
        </a>
      </li>

      <li class="nav-item">
        <a href="<?= htmlspecialchars(numart_url('aksi/logout.php?logout'), ENT_QUOTES, 'UTF-8'); ?>" onclick="return confirm('Apakah anda yakin logout ?')" class="nav-link">Logout <i class="fa fa-sign-out"></i>
        </a>
      </li>
    </ul>
  </nav>
