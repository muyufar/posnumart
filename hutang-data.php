...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "invoice_pembelian_cabang = $cabang && invoice_hutang > 0 && invoice_hutang_lunas = 0 && invoice_bayar < invoice_total" )
