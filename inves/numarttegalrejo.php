...
$tokoInfo = !empty($tokoResult) ? $tokoResult[0] : ['toko_nama' => 'Numart Tegalrejo'];
...
<head>
    ...
    <title>Dashboard Investor - <?php echo $tokoInfo['toko_nama'] ?? 'Numart Tegalrejo'; ?></title>
...
<body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center mt-2 mt-md-0">
                    <span class="text-white mr-3"><?php echo $tokoInfo['toko_nama'] ?? 'Numart Tegalrejo'; ?></span>
    ...
    <div class="main-content">
       ...
       <!-- Laba Rugi & Top Products -->
        ...
        <div class="footer">
            <p><strong><?php echo $tokoInfo['toko_nama'] ?? 'Numart Tegalrejo'; ?></strong> - Dashboard Investor</p>
