...
if ($fileTmpPath) {
    try {
        ...
        foreach ($data as $index => $row) {
            ...
            if (!$barang_kode || !$barang_nama) {
                writeLog("Baris $index dilewati: barang_kode atau barang_nama kosong.");
                continue;
            }
        ...
        $response['message'] = 'Terjadi kesalahan saat memproses file Excel.';
    }
} else {
