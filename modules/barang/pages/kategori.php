      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="tambah-data">
          	...
          	<a href="export/download_template_kategori.php" class="btn btn-danger">Download Template</a>
          	<form id="importForm" action="import/import-kategori.php" method="post" enctype="multipart/form-data" style="display:inline;">
            ...
            <form action="export/export-kategori.php" method="get" style="display:inline;">
...
document.getElementById('excelFileInput').addEventListener('change', (event) => {
    ...
    fetch('import/import-kategori.php', {
        method: 'POST',
        body: formData,
    })
