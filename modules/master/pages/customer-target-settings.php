...
require_once numart_path('api/wa-auto-schema.php');
require_once numart_path('api/wa-send-settings-lib.php');
require_once numart_path('api/wa-auto-blast-lib.php');
require_once numart_path('api/wa-message-lib.php');
