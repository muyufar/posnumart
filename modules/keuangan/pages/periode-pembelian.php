              ...
              <div class="table-auto">
                <table id="laporan-periode-pembelian" class="table table-bordered table-striped table-laporan">
                  ...
                  <tbody>
                    ...
                    $i = 1;
                    $total = 0;
                    $newQ = "SELECT invoice_pembelian.invoice_pembelian_id ,invoice_pembelian.pembelian_invoice, invoice_pembelian.invoice_tgl, supplier.supplier_id, supplier.supplier_nama, supplier.supplier_company, invoice_pembelian.invoice_total, invoice_pembelian.invoice_pembelian_cabang
                               FROM invoice_pembelian 
                               JOIN supplier ON invoice_pembelian.invoice_supplier = supplier.supplier_id
