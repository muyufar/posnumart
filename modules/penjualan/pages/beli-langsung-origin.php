...
if( isset($_POST["inputbarcode"]) ){
  // var_dump($_POST);
  $originBack = 'beli-langsung-origin' . (isset($_GET['customer']) ? ('?customer=' . urlencode((string) $_GET['customer'])) : '');

  // cek apakah data berhasil di tambahkan atau tidak
  if( tambahKeranjangBarcode($_POST) > 0 ) {
    echo "
      <script>
        document.location.href = " . json_encode($originBack) . ";
      </script>
    ";
  }  
}
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h4>Transaksi Kasir <b style="color: #007bff; ">Customer <?= $nameTipeHarga; ?></b></h4>
