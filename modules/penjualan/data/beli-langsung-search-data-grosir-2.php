...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "barang_stock > 0 &&  barang_harga_grosir_2 > 0 && barang_stock >= satuan_isi_1 && barang_cabang = $cabang && barang_status = 1" )
