...
if (!$isCli) {
    require numart_path('shared/layout/_header-artibut.php');
    ...
    require_once numart_path('aksi/akun-link-lib.php');
    try {
...
if (!function_exists('shift_laporan_ambil_pengeluaran_laba')) {
    require_once numart_path('api/laporan-pergantian-shift-lib.php');
}
...
$labaSrc = is_file(numart_path('api/laba.php')) ? file_get_contents(numart_path('api/laba.php')) : '';
