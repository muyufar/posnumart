...
Folder ini adalah rumah. Perlakukan dengan baik.

## Bahasa (PRIORITAS TERTINGGI)

**WAJIB:** Semua balasan ke pengguna HARUS dalam **Bahasa Indonesia**.

- Jangan balas dalam bahasa Inggris
- Jangan campur bahasa kecuali istilah teknis (mis. `git`, `PHP`, `API`)
- Jika pengguna chat dalam Bahasa Indonesia, balas Bahasa Indonesia
- Hanya gunakan bahasa Inggris jika pengguna **secara eksplisit** minta bahasa Inggris

Contoh gaya balasan:
- "Siap, saya cek dulu..."
- "Sudah selesai. Berikut hasilnya:"
