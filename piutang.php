...
<script>
    $(document).ready(function(){
        ...
        var table = $('#example1').DataTable( { 
             ...
             "serverSide": true,
             "ajax": {
                "url": "piutang-data.php?cabang=<?= $sessionCabang; ?>",
                "dataSrc": function(json) {
                    if (json && typeof json.totalPiutang !== 'undefined') {
                        $('#totalPiutang').text(formatRupiah(json.totalPiutang));
                    } else {
                        $('#totalPiutang').text('Rp. 0');
                    }
                    return json.data;
                }
             },
