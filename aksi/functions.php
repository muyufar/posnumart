	...
	if ($invoice_cek > 0) {
		...
		for ($x = 0; $x < $jumlah; $x++) {
			...
			if ($barang_id > 0) {
				...
				// Hindari jatuh ke harga beli terbaru saja jika stok master 0
				// atau master sudah terisi harga invoice terakhir (bukan HPP).
			...
			// Jika harga beli dari form 0, ambil dari HPP lama
			if ($harga_beli <= 0) {
